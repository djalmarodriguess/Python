...
if lambida_1 <= lambida_p1:
    ...
    Mn_FLA = Mpl - ((lambida_1 - lambida_p1) / (lambida_r3 - lambida_p1)) * (Mpl - Mr_1)
    print(f'Mn = {Mn_FLA:.2f}KNm')
    print('-='*30)
...
rais = sqrt(1+x**2)
Lr = (((19.9 * (rt**2) * (d/10)/((bf/10) * (tf/10)))/x) * sqrt(1+rais))
print(f'Lr = {Lr:.2f}cm')
...
print(f'Mn da Flecha = {Mn_2/100:.2f}kNm')
